...
async def status(update: Update, context: CallbackContext) -> None:
    if room_status:
        await update.message.reply_text(f"Xona band. Hozirda {room_status} namoz o'qiyotgan.")
    else:
...
async def enter(update: Update, context: CallbackContext) -> None:
    ...
    if room_status:
        await update.message.reply_text(f"Xona band. {room_status} hozir namoz o'qiyotgan.")
    else:
